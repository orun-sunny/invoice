  ...
  <div class="min-h-screen bg-gray-50 p-4">
    <div class="max-w-6xl mx-auto bg-white rounded-lg shadow">
      ...
      <div class="flex items-center justify-between p-4 border-b">
        <h1 class="text-lg font-medium text-blue-600">
          Product - Stock (E: {{ totalExisting }}, P: {{ totalPending }})
        </h1>
      ...
      <div class="p-4">
        <div class="grid grid-cols-12 gap-3 mb-4 items-center">
          <div class="col-span-3">
            <div class="relative">
              <select
                v-model="mainForm.product"
                class="w-full border border-gray-300 rounded px-3 py-2 appearance-none focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              >
